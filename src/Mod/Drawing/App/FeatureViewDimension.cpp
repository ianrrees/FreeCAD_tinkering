...
int FeatureViewDimension::get3DRef(int refIndex, std::string geomType) const
{
    int ref = -1;
...
void FeatureViewDimension::dumpRefs(char* text) const
{
...
double FeatureViewDimension::dist2Segs(Base::Vector2D s1,
                                       Base::Vector2D e1,
                                       Base::Vector2D s2,
