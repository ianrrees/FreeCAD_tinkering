...
class DrawingGuiExport ViewProviderAnnotation : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER(DrawingGui::ViewProviderAnnotation);
...
public:
    ...
    Drawing::FeatureViewAnnotation* getViewObject() const;
};
