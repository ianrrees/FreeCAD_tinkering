...
PROPERTY_SOURCE(DrawingGui::ViewProviderAnnotation, Gui::ViewProviderDocumentObject)
...
Drawing::FeatureViewAnnotation* ViewProviderAnnotation::getViewObject() const
{
    return dynamic_cast<Drawing::FeatureViewAnnotation*>(pcObject);
}
